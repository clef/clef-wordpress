(function(t,i){var s;return s=i.Model.extend({url:ajaxurl+"?action=ajax_settings_save",options:{},sync:function(t,s,n){var e;return n=n||{},n.emulateHTTP=!0,n.contentType="application/json",e=s.toJSON(),e=this.addActionToData(e),this.options.network_wide&&(e.network_wide=!0),n.data=JSON.stringify(e),i.Model.prototype.sync.call(this,t,s,n)},parse:function(t,i){return i.form?(this.options=i,this.url=""+ajaxurl+"?action=ajax_settings_save_"+this.options.options_name,this.options.url&&(this.url=this.options.url),this.options.network_wide&&(this.url+="&network_wide=true"),this.$form=this.options.form,_.extend(t,this.$form.serializeObject())):void 0},addActionToData:function(t){return t.action="ajax_settings_save_"+this.options.options_name,t},isNew:function(){return!1},update:function(i){var s;return s=t(i),s.is(":checkbox")&&(i.value=s.is(":checked")?1:0),this.saving=!0,this.save(i.name,i.value,{success:this.saveSuccess.bind(this),error:this.saveError.bind(this)})},saveSuccess:function(t,i){return this.saving=!1},saveError:function(t,i){return this.saving=!1},findInput:function(t,i){return null==i&&(i={}),this._is||(this._is={}),this._is[t]||(this._is[t]=this.$form.find("input, select, textarea").filter("[name='"+t+"']")),this._is[t]}}),t.fn.serializeObject=function(i){var s,n,e,o,r;for(n={},r=t(this).serializeArray(),e=0,o=r.length;o>e;e++)s=r[e],n[s.name]=s.value;return n},s.extend=i.Model.extend,this.AjaxSettingsModel=s}).call(this,jQuery,Backbone);
